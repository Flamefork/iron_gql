...
class GetAttachmentWithAttachmentImageParts(GetAttachmentBound[BaseParts | ImageParts]):
    # See: queries.py:38
...
class GetAttachmentWithAttachmentForeignParts(GetAttachmentBound[ForeignParts]):
    # See: queries.py:45
