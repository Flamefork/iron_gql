...
class GetAttachment(runtime.GQLTemplate):
    ...
    @overload
    def bind[TFillAttachment1: (ImageParts, LinkParts), TFillAttachment2: (ImageParts, LinkParts)](self, *, attachment: tuple[TFillAttachment1, TFillAttachment2], preview: Sequence[Never] = ()) -> GetAttachmentBound[GetAttachmentResult[TFillAttachment1 | TFillAttachment2, Never]]: ...
    @overload
    def bind[TFillAttachment1: (ImageParts, LinkParts), TFillAttachment2: (ImageParts, LinkParts), TModelPreview: pydantic.BaseModel, TReadsPreview](self, *, attachment: tuple[TFillAttachment1, TFillAttachment2], preview: OnImageAttachment[TModelPreview, TReadsPreview]) -> GetAttachmentBound[GetAttachmentResult[TFillAttachment1 | TFillAttachment2, OnImageAttachment[TModelPreview, TReadsPreview] | TReadsPreview]]: ...
    @overload
