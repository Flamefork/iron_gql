...
_API_GQL_BIND_DISPATCH: dict[slots.DispatchKey, runtime.BoundSpec] = {
    ...
    ('GetAttachment', (('preview', (_ImageFilesApplied,)),)): ('query GetAttachment($id: ID!, $files: [Upload]) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n    }\n    preview {\n      __typename\n      ...ImageFiles\n    }\n  }\n}\n\nfragment ImageFiles on ImageAttachment {\n  url(files: $files)\n}', {"attachment": (), "preview": ((ImageFiles, frozenset({'ImageAttachment'})),)}),
    # See: queries.py:3, queries.py:15
    ('GetAttachment', (('preview', (_ImagePartsApplied,)),)): ('query GetAttachment($id: ID!, $payload: JSON) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n    }\n    preview {\n      __typename\n      ...ImageParts\n    }\n  }\n}\n\nfragment ImageParts on ImageAttachment {\n  url(payload: $payload)\n}', {"attachment": (), "preview": ((ImageParts, frozenset({'ImageAttachment'})),)}),
    # See: queries.py:3, queries.py:23
    ('GetAttachment', (('attachment', (_ImageFilesApplied,)),)): ('query GetAttachment($id: ID!, $files: [Upload]) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...ImageFiles\n    }\n    preview {\n      __typename\n    }\n  }\n}\n\nfragment ImageFiles on ImageAttachment {\n  url(files: $files)\n}', {"attachment": ((ImageFiles, frozenset({'ImageAttachment'})),), "preview": ()}),
    # See: queries.py:3, queries.py:23
    ('GetAttachment', (('attachment', (_ImageFilesApplied,)), ('preview', (_ImageFilesApplied,)))): ('query GetAttachment($id: ID!, $files: [Upload]) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...ImageFiles\n    }\n    preview {\n      __typename\n      ...ImageFiles\n    }\n  }\n}\n\nfragment ImageFiles on ImageAttachment {\n  url(files: $files)\n}', {"attachment": ((ImageFiles, frozenset({'ImageAttachment'})),), "preview": ((ImageFiles, frozenset({'ImageAttachment'})),)}),
    # See: queries.py:3, queries.py:23, queries.py:15
    ('GetAttachment', (('attachment', (_ImageFilesApplied,)), ('preview', (_ImagePartsApplied,)))): ('query GetAttachment($id: ID!, $files: [Upload], $payload: JSON) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...ImageFiles\n    }\n    preview {\n      __typename\n      ...ImageParts\n    }\n  }\n}\n\nfragment ImageFiles on ImageAttachment {\n  url(files: $files)\n}\n\nfragment ImageParts on ImageAttachment {\n  url(payload: $payload)\n}', {"attachment": ((ImageFiles, frozenset({'ImageAttachment'})),), "preview": ((ImageParts, frozenset({'ImageAttachment'})),)}),
    # See: queries.py:3, queries.py:15
    ('GetAttachment', (('attachment', (_ImagePartsApplied,)),)): ('query GetAttachment($id: ID!, $payload: JSON) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...ImageParts\n    }\n    preview {\n      __typename\n    }\n  }\n}\n\nfragment ImageParts on ImageAttachment {\n  url(payload: $payload)\n}', {"attachment": ((ImageParts, frozenset({'ImageAttachment'})),), "preview": ()}),
    # See: queries.py:3, queries.py:15, queries.py:23
    ('GetAttachment', (('attachment', (_ImagePartsApplied,)), ('preview', (_ImageFilesApplied,)))): ('query GetAttachment($id: ID!, $files: [Upload], $payload: JSON) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...ImageParts\n    }\n    preview {\n      __typename\n      ...ImageFiles\n    }\n  }\n}\n\nfragment ImageFiles on ImageAttachment {\n  url(files: $files)\n}\n\nfragment ImageParts on ImageAttachment {\n  url(payload: $payload)\n}', {"attachment": ((ImageParts, frozenset({'ImageAttachment'})),), "preview": ((ImageFiles, frozenset({'ImageAttachment'})),)}),
    # See: queries.py:3, queries.py:15
    ('GetAttachment', (('attachment', (_ImagePartsApplied,)), ('preview', (_ImagePartsApplied,)))): ('query GetAttachment($id: ID!, $payload: JSON) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...ImageParts\n    }\n    preview {\n      __typename\n      ...ImageParts\n    }\n  }\n}\n\nfragment ImageParts on ImageAttachment {\n  url(payload: $payload)\n}', {"attachment": ((ImageParts, frozenset({'ImageAttachment'})),), "preview": ((ImageParts, frozenset({'ImageAttachment'})),)}),
}
