...
from tests.generated.interfaces_nested.settings import GRAPHQL_URL
...
class Child(GQLModel):
    id: builtins.str


class Node(GQLModel):
    typename__: Annotated[str, pydantic.Field(validation_alias="__typename", serialization_alias="__typename")]
    id: builtins.str
    child: Child | None
