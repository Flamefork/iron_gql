...
from tests.generated.interfaces_with_fragments.settings import GRAPHQL_URL
...
type GetNodeResultNode = Annotated[Post | User | Node, pydantic.Field(discriminator="typename__")]
