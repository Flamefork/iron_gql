...
class GetAttachmentWithAttachmentImagePartsLinkParts(GetAttachmentBound[ImageParts | LinkParts]):
    # See: queries.py:38
...
class GetAttachmentWithAttachmentOtherParts(GetAttachmentBound[OtherParts]):
    # See: queries.py:39
