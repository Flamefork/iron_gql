...
from tests.generated.bindings_disjoint.settings import GRAPHQL_URL
...
class GetAttachmentWithAttachmentOtherPartsResultPostAttachmentSlotImageAttachment(GQLSlotModel[OtherParts]):
    slot_name__: ClassVar[str] = "attachment"
    typename__: Annotated[Literal["ImageAttachment"], pydantic.Field(validation_alias="__typename", serialization_alias="__typename")]


class GetAttachmentWithAttachmentOtherPartsResultPostAttachmentSlotLinkAttachment(GQLSlotModel[OtherParts]):
    slot_name__: ClassVar[str] = "attachment"
    typename__: Annotated[Literal["LinkAttachment"], pydantic.Field(validation_alias="__typename", serialization_alias="__typename")]


type GetAttachmentWithAttachmentOtherPartsResultPostAttachmentSlot = Annotated[GetAttachmentWithAttachmentOtherPartsResultPostAttachmentSlotImageAttachment | GetAttachmentWithAttachmentOtherPartsResultPostAttachmentSlotLinkAttachment, pydantic.Field(discriminator="typename__")]


class GetAttachmentWithAttachmentOtherPartsPost(GQLModel):
    id: builtins.str
    attachment: GetAttachmentWithAttachmentOtherPartsResultPostAttachmentSlot | None


class GetAttachmentWithAttachmentOtherPartsResult(GQLModel):
    post: GetAttachmentWithAttachmentOtherPartsPost | None
...
class GetAttachmentWithAttachmentImagePartsLinkParts(GetAttachmentBound[GetAttachmentWithAttachmentImagePartsLinkPartsResult]):
    ...
    slot_handles__ = {"attachment": (slots.SlotHandle(IMAGE_PARTS, frozenset({'ImageAttachment'})), slots.SlotHandle(LINK_PARTS, frozenset({'LinkAttachment'})))}
    @override
...
class GetAttachmentWithAttachmentOtherParts(GetAttachmentBound[GetAttachmentWithAttachmentOtherPartsResult]):
    # See: queries.py:39
    exec_source__ = 'query GetAttachment($id: ID!) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...OtherParts\n    }\n  }\n}\n\nfragment OtherParts on ImageAttachment {\n  url\n}'
    slot_handles__ = {"attachment": (slots.SlotHandle(OTHER_PARTS, frozenset({'ImageAttachment'})),)}
    @override
    async def execute(self, *, id: builtins.str) -> GetAttachmentWithAttachmentOtherPartsResult:
        return await API_CLIENT.query(
            GetAttachmentWithAttachmentOtherPartsResult,
            self.exec_source__,
            variables={"id": id, **self.fragment_args__()},
            headers=self.headers,
            slot_handles=self.slot_handles__,
...
class GetAttachment(runtime.GQLTemplate):
    ...
    @overload
    def bind(self, *, attachment: OtherParts | Sequence[OtherParts]) -> GetAttachmentWithAttachmentOtherParts: ...
    @overload
...
_API_GQL_BIND_DISPATCH: dict[slots.BindKey, type[runtime.GQLBoundOperation]] = {
    ...
    ('GetAttachment', (('attachment', ('OtherParts',)),)): GetAttachmentWithAttachmentOtherParts,
}
