...
from tests.generated.bindings_two_typename_brick.settings import GRAPHQL_URL
...
@final
class LinkParts(OnLinkAttachment[LinkPartsData, "LinkParts | NodeId"]):
...
class GetAttachment(runtime.GQLTemplate):
    _binding_specs: ClassVar[dict[slots.BindingKey, runtime.BoundSpec]] = {
        ...
        (('attachment', (LinkParts,)),): ('query GetAttachment($id: ID!) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...LinkParts\n    }\n  }\n}\n\nfragment LinkParts on LinkAttachment {\n  href\n  ...NodeId\n}\n\nfragment NodeId on Node {\n  id\n}', {"attachment": ((LinkParts, frozenset({'LinkAttachment'})), (NodeId, frozenset({'LinkAttachment'})))}),
        # See: queries.py:29, queries.py:3
        (('attachment', (NodeId,)),): ('query GetAttachment($id: ID!) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...NodeId\n    }\n  }\n}\n\nfragment NodeId on Node {\n  id\n}', {"attachment": ((NodeId, frozenset({'ImageAttachment', 'LinkAttachment'})),)}),
        # See: queries.py:40
        (('attachment', (ImageParts, LinkParts)),): ('query GetAttachment($id: ID!) {\n  post(id: $id) {\n    id\n    attachment {\n      __typename\n      ...ImageParts\n      ...LinkParts\n    }\n  }\n}\n\nfragment ImageParts on ImageAttachment {\n  url\n  ...NodeId\n}\n\nfragment LinkParts on LinkAttachment {\n  href\n  ...NodeId\n}\n\nfragment NodeId on Node {\n  id\n}', {"attachment": ((ImageParts, frozenset({'ImageAttachment'})), (LinkParts, frozenset({'LinkAttachment'})), (NodeId, frozenset({'ImageAttachment', 'LinkAttachment'})))}),
    }
    ...
    @overload
    def bind[TFillAttachment1: (ImageParts | NodeId, LinkParts | NodeId), TFillAttachment2: (ImageParts | NodeId, LinkParts | NodeId)](self, *, attachment: tuple[TFillAttachment1, TFillAttachment2]) -> GetAttachmentBound[GetAttachmentResult[TFillAttachment1 | TFillAttachment2]]: ...
